...
function more_themes_page(){
        ...
        $rss = fetch_feed('http://feed.izt.me');			
        ...
        ?>
        <div class="info">
			<a target="_blank" href="http://www.izt.me/">爱主题</a>
			<a target="_blank" href="http://www.izt.me/category/wordpresstheme/freetheme/">高级主题</a>
			<a target="_blank" href="http://www.izt.me/category/wordpresstheme/freetheme">免费主题</a>
			<a target="_blank" href="http://www.izt.me/category/wordpresstheme/hhzx">汉化专区</a>
			<a target="_blank" href="http://www.izt.me/">更多主题</a>
			<a target="_blank" href="http://list.qq.com/cgi-bin/qf_invite?id=f787cf0c754b8d7a680140374c107295a5579926ebd07b7c">订阅</a>
		</div>
        <?php
	...
	function more_themes_recommend_page() {
	add_theme_page("WordPress More Themes", "<strong>爱主题</strong>", 0, 'morethemes', 'more_themes_page');
	}
	add_action('admin_menu', 'more_themes_recommend_page');
	endif;
?>