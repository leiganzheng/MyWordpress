...
<p>当前主题: HotNewspro 2.7.2 Plus版 | 设计者：<a href="http://zmingcx.com" target="_blank">知更鸟</a> <font style="font-size:20px;"color=#ff0000><strong> &hearts; </strong></font> <a href="https://me.alipay.com/zmingcx" target="_blank">支持作者</a> | <a href="http://zmingcx.com/hotnews-pro-theme-27.html" target="_blank">查看更新</a> | <a href="http://zmingcx.com/hotnews-pro-plus-faq.html" target="_blank">常见问题</a></p>
<div class="rm_opts">
<form method="post">
...
<span class="show_id">
    <h4>分类对应 ID</h4>
    <a href='http://me.alipay.com/zmingcx' target="_blank"><img src='https://img.alipay.com/sys/personalprod/style/mc/btn-index.png' /></a>
    <?php show_id();?>
</span>
