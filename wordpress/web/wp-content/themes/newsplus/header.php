    ...
    <div id="utility-top">
        <div class="wrap clear">
            ...
            <nav id="optional-nav" class="secondary-nav">
                <?php wp_nav_menu( array( 'theme_location' => 'secondary', 'menu_class' => 'sec-menu clear', 'container' => false, 'walker' => new Arrow_Walker_Nav_Menu, 'fallback_cb' => 'menu_reminder' ) ); ?>
            </nav><!-- #optional-nav -->
            <?php else : ?>
...
<?php endif; ?>
		...
		<nav id="main-nav" class="primary-nav" role="navigation">
            <div class="wrap">
                <?php wp_nav_menu( array( 'theme_location' => 'primary', 'menu_class' => 'nav-menu clear', 'container' => false, 'walker' => new Arrow_Walker_Nav_Menu, 'fallback_cb' => 'menu_reminder' ) ); ?>
