...
( function() {
	...
	var form = jQuery( '<div id="sc-posts-slider-form"><table id="sc-posts-slider-table" class="form-table">\
						...
						<tr>\
						<th><label for="sc-posts-slider-use_word_length">Use word length?</label></th>\
						<td><select name="use_word_length" id="sc-posts-slider-use_word_length">\
						...
						<tr>\
						<th><label for="sc-posts-slider-blog_id">Show posts from different blog</label></th>\
						<td><input type="text" id="sc-posts-slider-blog_id" name="blog_id" value="" /><br />\
